<?php
    ...
    */
	...
	$dv_config_list = "('Account Lock Time', 'Time it takes before account is release from freeze.', 'lock_expiry_span', '1' sha2(1, 256) ),
	...
	('configs', 'pword_expiry_span', '30', '1', '$date', '3', sha2(3, 256) ),
	('configs', 'pword_resetkey_length', '12', '1', '$date', '4', sha2(4, 256) )
	";
