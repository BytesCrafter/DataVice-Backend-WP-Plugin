# DATAVICE DEMO PLUGIN FOR WORDPRESS

The DataVice server for WordPress is a user management for your application or game users. This is an alternative to firebase which you can host your own.
